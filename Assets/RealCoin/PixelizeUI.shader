Shader "URP/PixelizeUI"
{
    Properties
    {
        ...
        //Time
        _AnimationTime("Animation Time",Range(0,30)) = 5
        _DelayTime("Delay Time",Range(0,30)) = 2.5
    ...
    SubShader
    {
         ...
         pass
        {
            ...
            half4 frag (vertexOutput i) : SV_TARGET
            {
                ...
                float customPeriodicFunction = remap(fmod(_Time.y,(_AnimationTime+_DelayTime)*0.5),0,_AnimationTime*0.5,0,1.0f);//此时处于Delay状态时值为1
                ...
                half4 mainTex;
                    ...
                    float currentIndex = fmod(customPeriodicFunction*_FrameNum+_FrameOffset*_FrameNum,_FrameNum);
